...
class Cascade_t2t_new_jit_mask_RoIHead(BaseRoIHead, RBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        ###### sen1ship dataset #####
        self.t2t_cls_head = ModuleList([nn.Linear(9*128, 2) for _ in range(self.num_stages)])
    ...
    def aug_test(self, features, proposal_list, img_metas, rescale=False):
        ...
        for x, img_meta in zip(features, img_metas):
            ...
            # "ms" in variable names means mulWti-stage
            ms_scores = []
        ...
        bbox_result = rbbox2result(det_bboxes, det_labels,
                                  self.bbox_head[-1].num_classes)
