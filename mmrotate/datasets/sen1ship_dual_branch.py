...
from mmrotate.datasets.dual_branch_custom import Dual_Branch_CustomDataset
...
# TODO: 修改加载图像和标签的函数，增加双分支的训练输入和验证



@ROTATED_DATASETS.register_module()
class Sen1shipDualBranchDataset(Dual_Branch_CustomDataset):
    """Sen1 SAR ship temporal dataset for detection.
    ...
    # # 双类别
    # CLASSES = ('ship_inshore','ship_offshore'  )
    # PALETTE = [
    #     # (0, 255, 0), (255, 255, 0),
    #     (255, 0, 0), (255, 0, 0),  # 都画成红色
    # ]
    ...
    def __init__(self,
        ...
        super(Sen1shipDualBranchDataset, self).__init__(ann_file, pipeline, **kwargs)
                ...
                with open(ann_file) as f:
                    ...
                    for si in s:
                        ...
                        try:
                            ...
                            continue
                        # cls_name = bbox_info[8]  # 双类别
                        cls_name = bbox_info[8].split('_')[0]  # 单类别
    ...
    #         logger=None,
    #         proposal_nums=(100, 300, 1000),
    #         iou_thr=[0.5, 0.75, 0.8, 0.85, 0.9, 0.95],
    #         scale_ranges=None,
    #         use_07_metric=True,
    #         nproc=4):
    #     """Evaluate the dataset.
