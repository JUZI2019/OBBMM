...
from mmdet_new.core import eval_map, eval_recalls
from mmdet_new.datasets.builder import DATASETS
from mmdet_new.datasets.pipelines import Compose


@DATASETS.register_module()
class Dual_Branch_CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.file_client = mmcv_new.FileClient(**file_client_args)
    ...
    def load_annotations(self, ann_file):
        ...
        return mmcv_new.load(ann_file)

    def load_proposals(self, proposal_file):
        """Load proposal from proposal file."""
        return mmcv_new.load(proposal_file)
    ...
    def _filter_imgs(self, min_size=32):
        ...
        if self.filter_empty_gt:
            warnings.warn(
                'Dual_Branch_CustomDataset does not support filtering empty gt images.')
        valid_inds = []
    ...
    def get_classes(cls, classes=None):
        ...
        if isinstance(classes, str):
            ...
            class_names = mmcv_new.list_from_file(classes)
