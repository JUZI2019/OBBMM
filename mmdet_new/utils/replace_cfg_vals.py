...
from mmcv_new.utils import Config
...
def replace_cfg_vals(ori_cfg):
    ...
    Args:
        ori_cfg (mmcv_new.utils.config.Config):
            The origin config with "${key}" generated from a file.

    Returns:
        updated_cfg [mmcv_new.utils.config.Config]:
    ...
    # the type of ori_cfg._cfg_dict is mmcv_new.utils.config.ConfigDict
    updated_cfg = Config(
