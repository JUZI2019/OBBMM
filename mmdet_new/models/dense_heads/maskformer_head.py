...
from mmdet_new.core import build_assigner, build_sampler, multi_apply, reduce_mean
from mmdet_new.models.utils import preprocess_panoptic_gt
...
class MaskFormerHead(AnchorFreeHead):
    ...
    Args:
        ...
        train_cfg (:obj:`mmcv_new.ConfigDict` | dict): Training config of
            Maskformer head.
        test_cfg (:obj:`mmcv_new.ConfigDict` | dict): Testing config of Maskformer
            head.
