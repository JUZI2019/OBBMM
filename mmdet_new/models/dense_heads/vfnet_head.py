...
from mmcv_new.cnn import ConvModule, Scale
from mmcv_new.ops import DeformConv2d
from mmcv_new.runner import force_fp32

from mmdet_new.core import (MlvlPointGenerator, bbox_overlaps, build_assigner,
    ...
    def forward_single(self, x, scale, scale_refine, stride, reg_denom):
        ...
        Args:
            ...
            scale (:obj: `mmcv_new.cnn.Scale`): Learnable scale module to resize
                the bbox prediction.
            scale_refine (:obj: `mmcv_new.cnn.Scale`): Learnable scale module to
