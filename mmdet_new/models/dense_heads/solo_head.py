...
from mmdet_new.core import InstanceData, mask_matrix_nms, multi_apply
from mmdet_new.core.utils import center_of_mass, generate_coordinate
from mmdet_new.models.builder import HEADS, build_loss
from mmdet_new.utils.misc import floordiv
    ...
    def _get_targets_single(self,
        ...
        for (lower_bound, upper_bound), stride, featmap_size, num_grid \
            ...
            for gt_mask, gt_label, pos_h_range, pos_w_range, \
                ...
                gt_mask = mmcv_new.imrescale(gt_mask, scale=1. / output_stride)
