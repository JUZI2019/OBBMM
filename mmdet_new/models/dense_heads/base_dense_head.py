...
import torch
from mmcv_new.cnn.utils.weight_init import constant_init
from mmcv_new.ops import batched_nms
from mmcv_new.runner import BaseModule, force_fp32

from mmdet_new.core.utils import filter_scores_and_topk, select_single_mlvl
...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def onnx_export(self,
        ...
        for cls_score, bbox_pred, score_factors, priors in zip(
            ...
            from mmdet_new.core.export import get_k_for_topk
        ...
        from mmdet_new.core.export import add_dummy_nms_for_onnx
