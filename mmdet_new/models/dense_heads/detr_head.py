...
from mmcv_new.cnn import Conv2d, Linear, build_activation_layer
from mmcv_new.cnn.bricks.transformer import FFN, build_positional_encoding
from mmcv_new.runner import force_fp32

from mmdet_new.core import (bbox_cxcywh_to_xyxy, bbox_xyxy_to_cxcywh,
                        build_assigner, build_sampler, multi_apply,
                        reduce_mean)
from mmdet_new.models.utils import build_transformer
...
class DETRHead(AnchorFreeHead):
    ...
    Args:
        ...
        transformer (obj:`mmcv_new.ConfigDict`|dict): Config for transformer.
            Default: None.
        sync_cls_avg_factor (bool): Whether to sync the avg_factor of
            all ranks. Default to False.
        positional_encoding (obj:`mmcv_new.ConfigDict`|dict):
            Config for position encoding.
        loss_cls (obj:`mmcv_new.ConfigDict`|dict): Config of the
            classification loss. Default `CrossEntropyLoss`.
        loss_bbox (obj:`mmcv_new.ConfigDict`|dict): Config of the
            regression loss. Default `L1Loss`.
        loss_iou (obj:`mmcv_new.ConfigDict`|dict): Config of the
            regression iou loss. Default `GIoULoss`.
        tran_cfg (obj:`mmcv_new.ConfigDict`|dict): Training config of
            transformer head.
    ...
    def forward_train(self,
        ...
        Args:
            ...
            proposal_cfg (mmcv_new.Config): Test / postprocessing configuration,
    ...
    def onnx_export(self, all_cls_scores_list, all_bbox_preds_list, img_metas):
        ...
        from mmdet_new.core.export import dynamic_clip_for_onnx
