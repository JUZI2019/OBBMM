...
from mmcv_new.cnn import (PLUGIN_LAYERS, Conv2d, ConvModule, caffe2_xavier_init,
...
from mmdet_new.core.anchor import MlvlPointGenerator
from mmdet_new.models.utils.transformer import MultiScaleDeformableAttention
...
class MSDeformAttnPixelDecoder(BaseModule):
    ...
    Args:
        ...
        norm_cfg (:obj:`mmcv_new.ConfigDict` | dict): Config for normalization.
            Defaults to dict(type='GN', num_groups=32).
        act_cfg (:obj:`mmcv_new.ConfigDict` | dict): Config for activation.
            Defaults to dict(type='ReLU').
        encoder (:obj:`mmcv_new.ConfigDict` | dict): Config for transformer
            encoder. Defaults to `DetrTransformerEncoder`.
        positional_encoding (:obj:`mmcv_new.ConfigDict` | dict): Config for
            transformer encoder position encoding. Defaults to
            dict(type='SinePositionalEncoding', num_feats=128,
            normalize=True).
        init_cfg (:obj:`mmcv_new.ConfigDict` | dict): Initialization config dict.
    """
