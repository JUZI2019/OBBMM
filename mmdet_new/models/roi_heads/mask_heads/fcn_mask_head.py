...
from mmcv_new.cnn import ConvModule, build_conv_layer, build_upsample_layer
from mmcv_new.ops.carafe import CARAFEPack
from mmcv_new.runner import BaseModule, ModuleList, auto_fp16, force_fp32
from torch.nn.modules.utils import _pair

from mmdet_new.core import mask_target
from mmdet_new.models.builder import HEADS, build_loss
...
class FCNMaskHead(BaseModule):
    ...
    def loss(self, mask_pred, mask_targets, labels):
        """
        Example:
            >>> from mmdet_new.models.roi_heads.mask_heads.fcn_mask_head import *  # NOQA
    ...
    def get_seg_masks(self, mask_pred, det_bboxes, det_labels, rcnn_test_cfg,
        ...
        Example:
            ...
            >>> rcnn_test_cfg = mmcv_new.Config({'mask_thr_binary': 0, })
            >>> ori_shape = (H * 4, W * 4)
