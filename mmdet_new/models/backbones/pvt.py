...
from mmcv_new.cnn import (Conv2d, build_activation_layer, build_norm_layer,
                      constant_init, normal_init, trunc_normal_init)
from mmcv_new.cnn.bricks.drop import build_dropout
from mmcv_new.cnn.bricks.transformer import MultiheadAttention
from mmcv_new.cnn.utils.weight_init import trunc_normal_
from mmcv_new.runner import (BaseModule, ModuleList, Sequential, _load_checkpoint,
                         load_state_dict)
...
class SpatialReductionAttention(MultiheadAttention):
    ...
    mmcv_new.cnn.bricks.transformer.
    ...
    def __init__(self,
        ...
        from mmdet_new import digit_version, mmcv_version
        if mmcv_version < digit_version('1.3.17'):
            warnings.warn('The legacy version of forward function in'
                          'SpatialReductionAttention is deprecated in'
                          'mmcv>=1.3.17 and will no longer support in the'
                          'future. Please upgrade your mmcv_new.')
