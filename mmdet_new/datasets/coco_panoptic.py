...
from mmdet_new.core import INSTANCE_OFFSET
...
class CocoPanopticDataset(CocoDataset):
    ...
    Args:
        ...
        file_client_args (:obj:`mmcv_new.ConfigDict` | dict): file client args.
    ...
    def _pan2json(self, results, outfile_prefix):
        ...
        for idx in range(len(self)):
            ...
            mmcv_new.imwrite(pan[:, :, ::-1], os.path.join(outdir, segm_file))
            record = {
                'image_id': img_id,
    ...
    def results2json(self, results, outfile_prefix):
        ...
        if 'pan_results' in results[0]:
            ...
            mmcv_new.dump(pan_json_results, result_files['panoptic'])
        ...
        if 'ins_results' in results[0]:
            ...
            mmcv_new.dump(bbox_json_results, result_files['bbox'])
            mmcv_new.dump(segm_json_results, result_files['segm'])
    ...
    def evaluate_pan_json(self,
        ...
        pred_json = mmcv_new.load(result_files['panoptic'])
        pred_json = dict(
