...
from mmdet_new.core import BitmapMasks, PolygonMasks
...
class LoadTwoBranchImageFromFile:
    ...
    Args:
        to_float32 (bool): Whether to convert the loaded image to a float32
            ...
            Defaults to False.
        color_type (str): The flag argument for :func:`mmcv_new.imfrombytes`.
            Defaults to 'color'.
        file_client_args (dict): Arguments to instantiate a FileClient.
            See :class:`mmcv_new.fileio.FileClient` for details.
    ...
    def __call__(self, results):
        ...
        Args:
            results (dict): Result dict from :obj:`mmdet_new.CustomDataset`.
...
class LoadMultiChannelImageFromFiles:
    ...
    def __call__(self, results):
        ...
        for name in filename:
            ...
            img.append(mmcv_new.imfrombytes(img_bytes, flag=self.color_type))
...
class LoadAnnotations:
    ...
    def _load_semantic_seg(self, results):
        ...
        img_bytes = self.file_client.get(filename)
        results['gt_semantic_seg'] = mmcv_new.imfrombytes(
