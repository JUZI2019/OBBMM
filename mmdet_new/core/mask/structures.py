...
import torch
from mmcv_new.ops.roi_align import roi_align
...
class BaseInstanceMasks(metaclass=ABCMeta):
    ...
    def rescale(self, scale, interpolation='nearest'):
        ...
        For details can refer to `mmcv_new.imrescale`.

        Args:
            scale (tuple[int]): The maximum size (h, w) of rescaled mask.
            interpolation (str): Same as :func:`mmcv_new.imrescale`.
    ...
    def resize(self, out_shape, interpolation='nearest'):
        ...
        Args:
            ...
            interpolation (str): See :func:`mmcv_new.imresize`.
    ...
    def crop_and_resize(self,
        ...
        Args:
            ...
            interpolation (str): See `mmcv_new.imresize`
    ...
    def translate(self,
        ...
        Args:
            ...
            interpolation (str): Same as :func:`mmcv_new.imtranslate`.
    ...
    def shear(self,
        ...
        Args:
            ...
            interpolation (str): Same as in :func:`mmcv_new.imshear`.
...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from mmdet_new.core.mask.structures import *  # NOQA
    ...
    def rescale(self, scale, interpolation='nearest'):
        ...
        if len(self.masks) == 0:
            new_w, new_h = mmcv_new.rescale_size((self.width, self.height), scale)
            rescaled_masks = np.empty((0, new_h, new_w), dtype=np.uint8)
        else:
            rescaled_masks = np.stack([
                mmcv_new.imrescale(mask, scale, interpolation=interpolation)
    ...
    def flip(self, flip_direction='horizontal'):
        ...
        if len(self.masks) == 0:
            ...
            flipped_masks = np.stack([
                mmcv_new.imflip(mask, direction=flip_direction)
                for mask in self.masks
            ])
    ...
    def pad(self, out_shape, pad_val=0):
        ...
        if len(self.masks) == 0:
            ...
            padded_masks = np.stack([
                mmcv_new.impad(mask, shape=out_shape, pad_val=pad_val)
                for mask in self.masks
            ])
    ...
    def translate(self,
        ...
        Example:
            >>> from mmdet_new.core.mask.structures import BitmapMasks
        ...
        if len(self.masks) == 0:
            ...
            translated_masks = mmcv_new.imtranslate(
    ...
    def shear(self,
        ...
        if len(self.masks) == 0:
            ...
            sheared_masks = mmcv_new.imshear(
                self.masks.transpose((1, 2, 0)),
                magnitude,
                direction,
    ...
    def rotate(self, out_shape, angle, center=None, scale=1.0, fill_val=0):
        ...
        if len(self.masks) == 0:
            ...
            rotated_masks = mmcv_new.imrotate(
                self.masks.transpose((1, 2, 0)),
                angle,
                center=center,
                scale=scale,
    ...
    def random(cls,
        ...
        """
        from mmdet_new.utils.util_random import ensure_rng
        rng = ensure_rng(rng)
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
        ...
        Example:
            >>> from mmdet_new.core.mask.structures import PolygonMasks
