...
from mmdet_new.core.bbox.iou_calculators import bbox_overlaps
from mmdet_new.core.bbox.transforms import bbox_cxcywh_to_xyxy, bbox_xyxy_to_cxcywh
...
class BBoxL1Cost:
    """BBoxL1Cost.
     ...
     Examples:
         >>> from mmdet_new.core.bbox.match_costs.match_cost import BBoxL1Cost
         >>> import torch
         >>> self = BBoxL1Cost()
...
class FocalLossCost:
    """FocalLossCost.
     ...
     Examples:
         >>> from mmdet_new.core.bbox.match_costs.match_cost import FocalLossCost
         >>> import torch
         >>> self = FocalLossCost()
...
class ClassificationCost:
    """ClsSoftmaxCost.
     ...
     Examples:
         >>> from mmdet_new.core.bbox.match_costs.match_cost import \
         ... ClassificationCost
         >>> import torch
...
class IoUCost:
    """IoUCost.
     ...
     Examples:
         >>> from mmdet_new.core.bbox.match_costs.match_cost import IoUCost
         >>> import torch
         >>> self = IoUCost()
...
class CrossEntropyLossCost:
    ...
    Examples:
         >>> from mmdet_new.core.bbox.match_costs import CrossEntropyLossCost
         >>> import torch
