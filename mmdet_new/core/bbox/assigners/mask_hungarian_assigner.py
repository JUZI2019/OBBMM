...
from mmdet_new.core.bbox.builder import BBOX_ASSIGNERS
from mmdet_new.core.bbox.match_costs.builder import build_match_cost
...
class MaskHungarianAssigner(BaseAssigner):
    ...
    Args:
        cls_cost (:obj:`mmcv_new.ConfigDict` | dict): Classification cost config.
        mask_cost (:obj:`mmcv_new.ConfigDict` | dict): Mask cost config.
        dice_cost (:obj:`mmcv_new.ConfigDict` | dict): Dice cost config.
    """
