...
from mmcv_new.runner import HOOKS
from mmcv_new.runner.dist_utils import master_only
from mmcv_new.runner.hooks.checkpoint import CheckpointHook
from mmcv_new.runner.hooks.logger.wandb import WandbLoggerHook
from mmcv_new.utils import digit_version

from mmdet_new.core import DistEvalHook, EvalHook
from mmdet_new.core.mask.structures import polygon_to_bitmap
...
class MMDetWandbHook(WandbLoggerHook):
    ...
    Comparing with the :cls:`mmcv_new.runner.WandbLoggerHook`, this hook can not
    ...
    - Checkpointing: If `log_checkpoint` is True, the checkpoint saved at
        ...
        This depends on the : class:`mmcv_new.runner.CheckpointHook` whose priority
    ...
    def _add_ground_truth(self, runner):
        ...
        for idx in self.eval_image_indexs:
            ...
            image = mmcv_new.bgr2rgb(img_meta['img'])
