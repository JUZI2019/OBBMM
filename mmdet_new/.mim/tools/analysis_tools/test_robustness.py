...
def voc_eval_with_return(result_file,
                         ...
                         logger='print',
                         only_ap=True):
    det_results = mmcv_new.load(result_file)
...
def main():
    ...
    cfg = mmcv_new.Config.fromfile(args.config)
    ...
    for corr_i, corruption in enumerate(corruptions):
        ...
        for sev_i, corruption_severity in enumerate(args.severities):
            ...
            if args.out and rank == 0:
                ...
                if cfg.dataset_type == 'VOCDataset':
                    if eval_types:
                        for eval_type in eval_types:
                            if eval_type == 'bbox':
                                test_dataset = mmcv_new.runner.obj_from_dict(
                ...
                mmcv_new.dump(aggregated_results, eval_results_filename)
