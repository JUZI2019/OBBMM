...
def collect_image_infos(path, exclude_extensions=None):
    ...
    images_generator = mmcv_new.scandir(path, recursive=True)
    for image_path in mmcv_new.track_iter_progress(list(images_generator)):
