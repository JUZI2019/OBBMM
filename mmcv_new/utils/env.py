...
def collect_env():
    ...
    if cuda_available:
        ...
        from mmcv_new.utils.parrots_wrapper import _get_cuda_home
    ...
    env_info['MMCV'] = mmcv_new.__version__

    try:
        from mmcv_new.ops import get_compiler_version, get_compiling_cuda_version
    except ModuleNotFoundError:
