...
def build_from_cfg(cfg: Dict,
    ...
    if not isinstance(registry, Registry):
        raise TypeError('registry must be an mmcv_new.Registry object, '
...
class Registry:
    ...
    Please refer to
    https://mmcv_new.readthedocs.io/en/latest/understand_mmcv/registry.html for
    advanced usage.
    ...
    def split_scope_key(key):
        ...
        Examples:
            >>> Registry.split_scope_key('mmdet_new.ResNet')
            'mmdet', 'ResNet'
    ...
    def _add_children(self, registry):
        ...
        Example:
            ...
            >>> class ResNet:
            >>>     pass
            >>> resnet = models.build(dict(type='mmdet_new.ResNet'))
        """
