...
import mmcv_new
from mmcv_new.cnn.rfsearch.utils import get_single_padding, write_to_json
from mmcv_new.runner import HOOKS, Hook
from mmcv_new.utils import get_logger
...
class RFSearchHook(Hook):
    ...
    def __init__(self,
        ...
        if rfstructure_file is not None:
            rfstructure = mmcv_new.load(rfstructure_file)['structure']
