...
from mmcv_new.utils import IS_NPU_AVAILABLE, TORCH_VERSION, digit_version
...
def allreduce_grads(params: List[Parameter],
    ...
    warnings.warn(
        '"mmcv_new.runner.fp16_utils.allreduce_grads" is deprecated, and will be '
        'removed in v2.8. Please switch to "mmcv_new.runner.allreduce_grads',
        DeprecationWarning)
