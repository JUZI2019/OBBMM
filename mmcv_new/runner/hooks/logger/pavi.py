...
import mmcv_new
from mmcv_new.parallel.scatter_gather import scatter
from mmcv_new.parallel.utils import is_module_wrapper
...
class PaviLoggerHook(LoggerHook):
    ...
    def before_run(self, runner) -> None:
        ...
        if runner.meta is not None:
            if 'config_dict' in runner.meta:
                ...
                config_dict = dict(mmcv_new.Config.fromfile(config_file))
            else:
                config_dict = None
            if config_dict is not None:
                ...
                # mmcv_new.dump to json
                config_dict = json.loads(
                    mmcv_new.dump(config_dict, file_format='json'))
    ...
    def _add_graph(self, runner, step: int) -> None:
        from mmcv_new.runner.iter_based_runner import IterLoader
