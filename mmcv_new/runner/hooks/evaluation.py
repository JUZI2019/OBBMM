...
from mmcv_new.utils import is_seq_of
...
class EvalHook(Hook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            test function ``mmcv_new.engine.single_gpu_test`` will be used.
            (default: ``None``)
        ...
        file_client_args (dict): Arguments to instantiate a FileClient.
            See :class:`mmcv_new.fileio.FileClient` for details. Default: None.
            `New in version 1.3.16.`
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from mmcv_new.engine import single_gpu_test
    ...
    def evaluate(self, runner, results):
        ...
        Args:
            runner (:obj:`mmcv_new.Runner`): The underlined training runner.
...
class DistEvalHook(EvalHook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            ``None``, the default test function ``mmcv_new.engine.multi_gpu_test``
            will be used. (default: ``None``)
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from mmcv_new.engine import multi_gpu_test
